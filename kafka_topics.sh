...
kafka-topics --create --topic main_topic --partitions 3 --replication-factor 3 --if-not-exists --zookeeper 194.61.2.84:5099
kafka-topics --create --topic dead_letter --partitions 3 --replication-factor 3 --if-not-exists --zookeeper 194.61.2.84:5099
kafka-topics --describe --topic main_topic --zookeeper 194.61.2.84:25099
